         ...
         <div class="row">
            ...
            <div class="row bottom-spacer-20">
               ...
               <div class="col-md-6 top-spacer-20">
                  ...
                  <br><span class="empnumbersize">Status:</span><span class="empnamesize"> <?php echo $status = $row['STATUSCD']; ?></span>
            ...
            ?>
               ...
               <div class="col-md-3">
                  <button type="button" title="Add Earning" class="btn green btn-block fa fa-plus-square" data-toggle="modal" data-target="#newemployeeearning">
                     Add Earning</button>
            ...
            <div id="newemployeeearning" class="modal fade" tabindex="-1" data-width="560">
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     <div class="modal-header modal-title" style="background: #6e7dc7;">
                        <h4 class=" modal-title" style="text-transform: uppercase;">Add New Earning for this Employee</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                           <span aria-hidden="true">&times;</span>
                        </button>
                     </div>
            ...
            <div class="modal fade" id="newtempemployeededuction" tabindex="-1" role="dialog" aria-labelledby="newtempemployeededuction" aria-hidden="true">
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body">
                        <form class="form-horizontal" name="form_newtempemployeededuction" id="form_newtempemployeededuction" method="post" action="classes/controller.php?act=newtempemployeededuction">
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-body">
                                    <input type="hidden" name="curremployee" value="<?php echo $staffID; ?>">
