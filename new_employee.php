...
<div class="row" id="form">
	...
	<div class="col-md-12">
        ...
        <div class="form-group">
            ...
            $final = $payp->fetch();
                                                                            ...
                                                                            //End ED Fetch
					?>
			<label for="employee_no" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Employee No:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
				<input type="text" name="emp_no" value="<?php echo intval($final['nextNo'])+1;?>" class="form-inps focus" id="emp_no" readonly>			</div>
			</div>
        <div class="form-group"> 
			<label for="first_name" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Employee Name:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
				<input type="text" name="name" value="" class="form-inps focus" id="name" required>			</div>
		</div>
				 
        
        <div class="form-group">
			<label for="payType" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Call Duty Type:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
			  <p>
			  	<label>
        ...
        <div class="form-group">
			<label for="state" class="required col-sm-3 col-md-3 col-lg-2 control-label ">State:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
    ...
    echo "<option value='". $row['state_id']."'>".$row['State']."</option>";
        ...
        <div class="form-group">
			<label for="lg" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Local Govt:</label>			
         ...
         <div class="form-group">
			<label for="dept" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Dept:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
    ...
    echo "<option value='". $row['dept_id']."'>".$row['dept']."</option>";
         ...
         <div class="form-group">
			<label for="grade" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Grade:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
            
             	<input type="text" name="grade" value="" class="form-inps focus" id="grade" required maxlength="3">			</div>
		 </div>
		</div>
        ...
        <div class="form-group">
			...
			<label for="grade" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Step:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
            <input type="text" name="gradestep" value="" class="form-inps focus" id="gradestep" required maxlength="2">			</div>
		
            </div>
		</div>
        
        <div class="form-group">
			<label for="dob" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Date of Birth:</label>			<div class="col-sm-9 col-md-9 col-lg-10"><?php $today = date('Y-m-d');?>
			<input name="dob" type="date" required="required" class="form-inps" id="dob" max="<?php echo $today; ?>">			</div>
		</div>
        
        <div class="form-group">
			<label for="doe" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Date of Employment:</label>			<div class="col-sm-9 col-md-9 col-lg-10"><?php $today = date('Y-m-d');?>
			<input name="doe" type="date" required="required" class="form-inps" id="doe" max="<?php echo $today; ?>">			</div>
		</div>
        
        <div class="form-group">
			<label for="bank" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Bank:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
    ...
    echo "<option value='". $row['BCODE']."'>".$row['BNAME']."</option>";
            ...
            <div class="form-group">
			<label for="acct_no" class="required col-sm-3 col-md-3 col-lg-2 control-label ">Account No:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
			<input name="acct_no" type="text" class="form-inps" id="acct_no" autocomplete="off">			</div>
		</div>
        
         <div class="form-group">
			<label for="pfa" class="required col-sm-3 col-md-3 col-lg-2 control-label ">PFA:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
    ...
    echo "<option value='". $row['pfacode']."'>".$row['pfaname']."</option>";
        ...
        <div class="form-group">
			<label for="rsa_pin" class="required col-sm-3 col-md-3 col-lg-2 control-label ">PIN:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
			<input name="rsa_pin" type="text" required="required" class="form-inps" id="rsa_pin"  >			</div>
		</div>
      <!--hide below-->
<div id="hide_grid" hidden="true">
			...
			<input type="text" name="email" class="form-inps" id="email">			</div>
		</div>
					<div class="form-group">	
		<label for="phone_number" class="col-sm-3 col-md-3 col-lg-2 control-label ">Phone Number:</label>			<div class="col-sm-9 col-md-9 col-lg-10">
			<input type="text" name="phone_number" class="form-inps" id="phone_number">			</div>
		</div>
		<div class="form-group">	
...
<label for="state" class="col-sm-3 col-md-3 col-lg-2 control-label ">State/Province:</label>	<div class="col-sm-9 col-md-9 col-lg-10">
	<input type="text" name="state" class="form-control form-inps" id="state">	</div>
</div>
...
<label for="country" class="col-sm-3 col-md-3 col-lg-2 control-label ">Country:</label>	
                <div class="col-sm-9 col-md-9 col-lg-10">
	<input type="text" name="country" class="form-control form-inps" id="country">	</div>
</div>
