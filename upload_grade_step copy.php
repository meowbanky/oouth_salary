	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix sales_content_minibar">
			...
			<div id="breadcrumb" class="hidden-print">
				...
				<a class="current" href="upload_grade_step.php">Update Bulk Grade/Step</a>
			</div>
			<div class="clear"></div>
			...
			<!-- BEGIN PAGE TITLE-->
			<div class="container">
				<h1 class="page-title"> Update Bulk Grade/Step from Excel
										...
										<div class="col-md-4">
											<div class="form-body">
												<div class="form-group">
													...
													<a href="download/grade_step.xlsx">Grade/Step Template</a>
		...
		$(document).ready(function() {
			...
			$("#upload").click(function() {
				...
				$("#upload_excel").ajaxSubmit({
					url: 'excel_import/import_grade_step.php',
					data: {
