...
<body data-color="grey" class="flat">
    ...
    <div id="wrapper">
        <div id="header" class="hidden-print">
            <h1><a href="../index.php"><img src="images/oouth_logo.png" class="hidden-print header-log" id="header-logo"
                        alt=""></a></h1>
        ...
        <div id="user-nav" class="hidden-print hidden-xs">
            <ul class="btn-group ">
                ...
                <li class="btn  hidden-xs disabled">
                    <a title="" href="/" onclick="return false;"><i class="icon fa fa-clock-o fa-2x"></i> <span
                            class="text">
                            <?php
        ...
        <div id="content" class="clearfix sales_content_minibar">
            ...
            <div id="content-header" class="hidden-print">
                <h1><i class="fa fa-beaker"></i> Report Input</h1> <span id="ajax-loader"><img src="img/ajax-loader.gif"
                        alt="" /></span>
            </div>

            <div id="breadcrumb" class="hidden-print">
                <a href="../home.php"><i class="fa fa-home"></i> Dashboard</a><a href="index.php">Reports</a><a
                    class="current" href="payslip_personal.php">Report Input: Detailed Payslip individual</a>
            </div>
            <div class="clear"></div>
            <div class="row">
                <div class="col-md-12">
                    <div class="widget-box">
                        ...
                        ?>
                            ...
                            <div class="col-md-12 pull-left">
                                <img src="img/oouth_logo.gif" width="10%" height="10%" class="header-logo hidden-print"
                                    id="header-logo" alt="">
                            ...
                            <div class="col-md-12 hidden-print">
                                <form class="form-horizontal form-horizontal-mobiles" method="POST"
                                    action="payslip_dept.php">
                                    <div class="form-group">
                                        <label for="range"
                                            class="col-sm-3 col-md-3 col-lg-2 control-label hidden-print">Pay Period
                                            :</label>
                                        <div class="col-sm-9 col-md-9 col-lg-10">&nbsp;
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                        class="fa fa-location-arrow hidden-print"></i></span>
                                ...
                                <div class="form-group">
                                    <label for="range"
                                        class="col-sm-3 col-md-3 col-lg-2 control-label hidden-print">Name :</label>
                                    <div class="col-sm-9 col-md-9 col-lg-10">&nbsp;
                                        <form action="payslip_personal.php" method="post" accept-charset="utf-8"
                                            id="add_item_form" autocomplete="off">
                                            <span role="status" aria-live="polite"
                                                class="ui-helper-hidden-accessible"></span>
                                            <input type="text" name="item" value="" id="item"
                                                class="ui-autocomplete-input" accesskey="i"
                                    ...
                                    <div class="form-actions">
                                        <button name="generate_report" type="submit" id="generate_report"
                                            class="btn btn-primary submit_button btn-large hidden-print">Submit</button>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="loading-indicator" style="display:none;"><img
                                                            src="img/ajax-loader.gif" alt="">Sending mail...</div>
                                                    <div class="form-group">
                                                                ...
                                                                <div class=" payslip-header">
                                                                    ...
                                                                    <div class="row header-label">
                                                                        <div class="col-md-6 col-xs-6"
                                                                            ...
                                                                            <?php print_r($thisemployee); ?>
                                                                            <input type="hidden" name="staff_no"
                                                                                id="staff_no"
                                                                                value="<?php echo $thisemployee ?>">
                ...
                select: function(event, ui) {
                    ...
                    $('#add_item_form').ajaxSubmit({
                        ...
                        success: function(data) {
                            window.location.href = "payslip_personal.php?item=" +
                                $item + "&period=" + $period;
                        }
                ...
                $('#form_payprocess').ajaxSubmit({
                    ...
                    success: function(response, message) {
                        if (message == 'success') {
                            ...
                            gritter("Success", message, 'gritter-item-success', false,
                                false);
