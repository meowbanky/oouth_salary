					...
					<table style="border:1px solid black" class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                            <thead>
            									...
            									<tbody>
                                                    ...
                                                    <td class="stylecaps"> <strong>Earnings</strong> </td>
                                                                ...
                                                                foreach ($res as $row => $link) {
                                                                    ?>
                                                                        <?php 
																			...
																			echo '<td class="stylecaps"><div class="row">';
                                      echo '<div class="col-sm-6 pull-left" style="text-align:left"><strong>' . $link['ed'] .  '</strong></div>';	
                                      echo '<div class="col-sm-6 pull-right" style="text-align:right"><strong>' . number_format($link['allow']) . '</strong></div>';
                                      echo  '</div></td>';
                                   		...
                                   		$sumAll = $sumAll+floatval($link['allow']);
																...
																echo '<td class="stylecaps"><div class="row">';
																echo '<div class="col-sm-6 pull-left" style="text-align:left"><strong>TOTAL earnings</strong></div>';
																echo '<div class="col-sm-6 pull-right" style="text-align:right"><strong>'. number_format($sumAll) .'</div>';
																 echo  '</div></td>';
                                ...
                                echo '<tr class="odd gradeX">';
																...
																echo '<td class="stylecaps"><strong>DEDUCTIONS</strong></td>';
                                      ...
                                      echo '<td class="stylecaps"><div class="row">';                                 
																			echo '<div class="col-sm-6 pull-left" style="text-align:left"><strong>'. $link['ed'] .  '</strong></div>';
																			echo '<div class="col-sm-6 pull-left" style="text-align:right"><strong>' . number_format($link['deduct']) . '</strong></div>';
                                   		echo  '</div></td>';
                                   		$sumDeduct = $sumDeduct+floatval($link['deduct']);
																...
																echo '<td class="stylecaps"><div class="row">'; 
																echo '<div class="col-sm-6 pull-left" style="text-align:left"><strong>TOTAL DEDUCTIONS</strong></div>';
																echo '<div class="col-sm-6 pull-left" style="text-align:right"><strong>' . number_format($sumDeduct) . '</strong></div>';
																echo '</div></td>';
                                ...
                                echo '<tr class="odd gradeX">';
                               	...
                               	echo '<td class="stylecaps"><div class="row">'; 
																echo '<div class="col-sm-6 pull-left" style="text-align:left"><strong>NET PAY</strong></div>'; 
																echo '<div class="col-sm-6 pull-left" style="text-align:right"><strong>' . number_format(floatval($sumAll)- floatval($sumDeduct)) . '</strong></div>';
																echo '</div></td>';
