...
// Define sidebar menu items with correct paths for report directory
$menuItems = [
    ['href' => '../home.php', 'icon' => 'fas fa-home', 'label' => 'Dashboard'],
    ['href' => 'index.php', 'icon' => 'fas fa-file-lines', 'label' => 'Reports'],
    ['href' => '../index.php', 'icon' => 'fas fa-power-off', 'label' => 'Logout'],
];

// Admin-only menu items with correct paths for report directory
$adminItems = [
    ...
    ['href' => '../payprocess.php', 'icon' => 'fas fa-cog', 'label' => 'Process Payroll'],
    ...
    <ul class="space-y-2">
        ...
        <li>
            <a href="<?php echo $item['href']; ?>"
                class="flex items-center py-2 px-4 rounded transition-colors duration-200 sidebar-link"
                style="background-color: <?php echo $currentPage === basename($item['href']) ? 'var(--text-accent)' : 'transparent'; ?>; color: var(--text-primary);"
                onmouseover="this.style.backgroundColor='<?php echo $currentPage === basename($item['href']) ? 'var(--text-accent)' : 'var(--bg-hover)'; ?>'; this.style.color='var(--text-primary)';"
                onmouseout="this.style.backgroundColor='<?php echo $currentPage === basename($item['href']) ? 'var(--text-accent)' : 'transparent'; ?>'; this.style.color='var(--text-primary)';">
