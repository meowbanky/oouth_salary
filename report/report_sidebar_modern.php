    ...
    <ul class="space-y-2">
        ...
        <li>
            <a href="<?php echo $item['href']; ?>"
                ...
                onmouseover="this.style.backgroundColor='<?php echo $currentPage === basename($item['href']) ? 'var(--text-accent)' : 'var(--bg-hover)'; ?>'"
                onmouseout="this.style.backgroundColor='<?php echo $currentPage === basename($item['href']) ? 'var(--text-accent)' : 'transparent'; ?>'">
