						...
						<?php if ($month != '') { ?><div class="top-panel pull-right hidden-print">
								<div class="btn-group">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li><a onclick="exportAll('xls','<?php echo $month . ' banksummary'; ?>');" href="javascript://">XLS</a></li>
										<li><a onclick="exportAll('csv','<?php echo $month . ' banksummary'; ?>');" href="javascript://">CSV</a></li>
										<li><a onclick="exportAll('txt','<?php echo $month . ' banksummary'; ?>');" href="javascript://">TXT</a></li>
