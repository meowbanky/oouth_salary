...
<div id="wrapper">
                        ...
                        <div class="col-md-12 hidden-print">
                            <form id="deduction_form" class="form-horizontal form-horizontal-mobiles" method="POST" action="deductionlist.php">
                                ...
                                <div class="form-actions" style="display: flex; gap: 10px;">
                                    ...
                                    <button name="send_mail" id="send_mail" type="submit" class="btn btn-primary submit_button btn-large hidden-print">Send Mail</button>
                            ...
                            <div id="export-loading" style="display: none;">
                                <i class="fas fa-spinner fa-spin"></i> Generating file...
                            </div>
                        </div>
                    </div>
                    <div id="download"></div>
    ...
    <div id="footer" class="col-md-12 hidden-print">
        Please visit our
        <a href="http://www.oouth.com/" target="_blank">website </a>
