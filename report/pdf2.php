...
$filename = $out['NAME'] . '-' . $fullPeriod . '.pdf';
...
try {
    ...
    $mail->Host       = 'mail.oouth.com';                     //Set the SMTP server to send through
    $mail->SMTPAuth   = true;                                   //Enable SMTP authentication
    $mail->Username   = 'no-reply@oouth.com';                     //SMTP username
    $mail->Password   = 'vZsP[-p;LWFu';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('no-reply@oouth.com', 'OOUTH SALARY UNIT');
    $mail->addAddress('bankole.adesoji@gmail.com', $out['BNAME']);     //Add a recipient
    ...
    $mail->Subject = 'Pay Slip';
    $mail->Body    = 'Attached is your payslip for the month of ' . $fullPeriod;
