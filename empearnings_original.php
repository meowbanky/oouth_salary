...
<body data-color="grey" class="flat" style="zoom: 1;">
        ...
        <div id="content" class="clearfix sales_content_minibar">
            ...
            <div class="row">
                    ...
                    <div class="row payperiod">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <?php echo $_SESSION['activeperiodDescription']; ?> &nbsp; <span
                                        class="label label-inverse label-sm label-success"> Open </span>
                                </div>
                            </div>
                        </div>
               ...
               ?>
                  ...
                  ?>
                        <div class="empname"> <span class="empnumbersize"> Emp # <?php echo $staffID . ' : '; ?></span>
                            <span class="empnamesize"> <?php echo $empfname; ?> </span></div>
                        <span class="empnumbersize">Grade Level:</span> <span class="empnamesize">
                            <?php echo $empGrade; ?>/<?php echo $empStep; ?></span>
                        <br><span class="empnumbersize">Dept:</span><span class="empnamesize">
                            <?php echo $dept; ?></span>
                        <br><span class="empnumbersize">Status:</span><span class="empnamesize">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <div class="input-icon">
                                        <form action="classes/controller.php?act=retrieveSingleEmployeeData"
                                            method="post" accept-charset="utf-8" id="add_item_form" class="form-inline"
                                            autocomplete="off">
                                            <i class="fa fa-user fa-fw"></i>
                                            <input type="text" name="item" value="" id="item" class="form-control"
                                                required="required" accesskey="i"
                                                placeholder="Enter Staff Name or Staff No" /><span id="ajax-loader"><img
                                                    src="img/ajax-loader.gif" alt="" /></span>
                    ...
                    <div class="col-md-3 top-spacer-20">
                        <div class="pull-right">
                            ...
                            <a href="classes/controller.php?act=getNextEmployee&track=<?php echo $_SESSION['emptrack'] + 1; ?>"
                                class="earnings">Next Employee <i class="fa fa-angle-double-right fa-lg"
                    ...
                    <div class="portlet-body">
                        ...
                        ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <button class="btn btn-sm btn-primary" type="button">
                                                            Payroll Period <span
                                                                class="badge"><?php print $_SESSION['activeperiodDescription'] ?></span>
                                                        </button>
                                                        <button class="btn btn-sm purple" type="button">
                                                            Number of Employees <span
                                                                class="badge"><?php print $count ?></span>
                                                        </button>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="btn-group pull-right">
                                                            <button class="btn btn-sm red" id="btnPrint">Print <i
                                                            ...
                                                            <div id="printThis" class="printMe payslip-wrapper">
                                                                <div class="payslip-header">
                                                                    <div class="row header-label">
                                                                        ...
                                                                        <div class="col-md-12 txt-ctr text-uppercase">
                                                                            <b> PAYSLIP FOR <b>
                                                                                    <?php echo $fullPeriod; ?> </b></b>
                                                                        </div>

                                                                    </div>
                                                                    <div class="row header-label">
                                                                        <div class="col-md-6 col-xs-6">
                                                                            <span class="pay-header-item"
                                                                  ...
                                                                  ?>
                                                                        ...
                                                                        <div class="col-md-6 col-xs-6 txt-left"
                                                                    ...
                                                                    <div class="row header-label">
                                                                        <div class="col-md-6 col-xs-6"
                                                                            style="white-space:nowrap;">Staff No.:
                                                               ...
                                                               ?>
                                                                    ...
                                                                    <div class="row header-label">
                                                                        <div class="col-md-6 col-xs-6"
                                                                            style="white-space:nowrap;">Acct No.:
                                                                            <?php
                                                               echo $out['ACCTNO'];
                                                               ?>
                                                                        </div>
                                                                    ...
                                                                    <div class="row header-label">
                                                                        ...
                                                                        <div class="col-md-6 col-xs-6"
                                                                            style="white-space:nowrap;">CONSOLIDATED:
                                                                            <?php
                                                   ...
                                                   ?>
                                                         ...
                                                         ?>
                                                                    ...
                                                                    <div class="row payslip-total">
                                                                        <div class="col-md-8 col-xs-8"><b>Total
                                                                                Allowance</b></div>
                                                                        <div class="col-md-4 col-xs-4 payslip-amount">
                                                                            <b>
                                                                                <?php
                                                               echo number_format($totalAllow);
                                                               ?>
                                                                            </b></div>
                                                                        <div class="col-md-8 col-xs-8"><b>Gross
                                                                                Salary</b></div>
                                                                        <div class="col-md-4 col-xs-4 payslip-amount">
                                                                            <b>
                                                                                <?php
                                                         ...
                                                         ?>
                                                               ...
                                                               ?>
                                                                ...
                                                                <div class="payslip-body">
                                                                    ...
                                                                    <div class="row payslip-total">
                                                                        <div class="col-md-8 col-xs-8"><b>Net Pay</b>
                                                                        </div>
                                                                        <div class="col-md-4 col-xs-4 payslip-amount">
                                                                            <b>
                                                                                <?php
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button class="btn red" id="btnPrint">Print <i class="fa fa-print"
                        ...
                        ?>
                                ...
                                <div class="table-responsive" id="reloadtable">
                                 ...
                                 ?> <tr class="odd gradeX">
                                             ...
                                             ?>
                                                <!--Delete ED-->
                                                <div id="deleteed<?php echo $link['temp_id']; ?>" class="modal fade"
                                                    tabindex="-1" data-width="560">
                                                    <div class="modal-dialog" role="document">
                                                        <form class="form-horizontal" method="post"
                                                            action="classes/controller.php?act=deactivateEd">
                                                            <div class="modal-content">
                                                                <div class="modal-header modal-title"
                                                                    style="background: #6e7dc7;">
                                                                    <h4 class="modal-title"
                                                                        style="text-transform: uppercase;">Delete
                                                                        Employee Earning / Deduction</h4>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-md-7">
                                                                                        <input type="text" required
                                                                                            class="form-control"
                                                                                            name="editname" disabled=""
                                                                                            value="<?php echo $link['edDesc']; ?>">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        class="col-md-4 control-label">Amount
                                                                                    </label>
                                                                                    <div class="col-md-7">
                                                                                        <input type="text" required
                                                                                            class="form-control"
                                                                                            name="editvalue" disabled=""
                                                                                            value="<?php echo number_format($link['value']); ?>">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <button type="button" data-dismiss="modal"
                                                                        class="btn btn-outline dark">Close</button>
                                                                    <button type="submit"
                                                                        class="btn red deletedItem">Delete E/D</button>
                                                        </form>
                                                    </div>
                                                </div>
                                </div>
            ...
            ?>
                     ...
                     ?>
                                <!--Delete ED-->
                                <div id="deleteed<?php echo $link2['temp_id']; ?>" class="modal fade" tabindex="-1"
                                    data-width="560">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                                            ...
                                                            <div class="form-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        <input type="text" required class="form-control"
                                                                            name="editvalue" disabled=""
                                                                            value="<?php echo number_format($link2['value']); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
               ...
               ?>
                            ...
                            <tr class="earnings-row">
                                ...
                                <th align-right colspan="3"><?php echo number_format(($gross - $totalDeduction)); ?>
                                </th>
                            </tr>
                            </tbody>
                            </table>
                    ...
                    <div class="col-md-3">
                        <button type="button" title="Add Earning/Deduction"
                            class="btn green btn-block fa fa-plus-square" data-toggle="modal"
                            data-target="#newemployeeearning">
                        ...
                        <button type="button" title="Add Temporary Deduction/Allowance"
                            class="btn red btn-block fa fa-minus-square" data-toggle="modal"
                            data-target="#newtempemployeededuction"> Add Temp. Deduction/Allowance </button>
                        <button type="button" title="Add Loan/Corporate" class="btn red btn-block fa fa-minus-square"
                            data-toggle="modal" data-target="#loan_corporate"> Add Loan/Corporate </button>
                        <form method="post" id="form_runPayslip" action="classes/runPayrollindividual.php">
                            <input type="hidden" id="thisemployeePayslip" name="thisemployeePayslip"
                            ...
                            <button type="button" class="btn btn-block black top-spacer-5" id="runPayslip" <?php $j =  retrievePayrollRunStatus($staffID, $_SESSION['currentactiveperiod']);
                                ...
                                Employee's Payroll <i class="fa fa-refresh" aria-hidden="true"></i></button>
                        </form>
                        <form method="post" id="form_deletePayslip"
                            action="assets/classes/controller.php?act=deletecurrentstaffPayslip">
                            ...
                            <button type="button" class="btn btn-block black top-spacer-5" id="deletePayslip" <?php $j =  retrievePayrollRunStatus($staffID, $_SESSION['currentactiveperiod']);
                                ...
                                this Emp Payslip <i class="fa fa-refresh" aria-hidden="true"></i></button>
                        </form>
                        <button type="button" title="View employee Payslip" class="btn blue btn-block top-spacer-5"
                            data-toggle="modal" data-target="#viewemployeepayslip"
                            <?php $j =  retrievePayrollRunStatus($staffID, $_SESSION['currentactiveperiod']);
                                                                                                                                                                     if ($j == '0') {
                                                                                                                                                                        echo 'disabled="disabled"';
                                                                                                                                                                     } ?>>
                            View Employee Payslip <i class="fa fa-file-text" aria-hidden="true"></i></button>
                        <button type="button" title="Pro-rate" class="btn red btn-block fa fa-minus-square"
                            data-toggle="modal" data-target="#prorate"> Pro-rate Allow </button>
                        <button type="button" title="Update Grade/Step" class="btn red btn-block fa fa-minus-square"
                            data-toggle="modal" data-target="#gradeStep"> Update Grade/Step </button>
                    </div>
                </div>
                ...
                <div id="newemployeeearning" class="modal fade" tabindex="-1" data-width="560">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                <h4 class=" modal-title" style="text-transform: uppercase;">Add New Earning/Deduction
                                    for this Employee</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newearningcode" id="form_newearningcode"
                                    method="post" action="classes/controller.php?act=addemployeeearning">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                    value="<?php echo $staffID; ?>">
                                                <input type="hidden" name="grade_level"
                                                    value="<?php echo $empGrade; ?>">
                                                <input type="hidden" name="step" value="<?php echo $empStep; ?>">
                                                <input type="hidden" name="callType" value="<?php echo $callType; ?>">
                                                <input type="hidden" name="HARZAD_TYPE"
                                                    value="<?php echo $HARZAD_TYPE; ?>">
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Description</label>
                                                    <div class="col-md-7">
                                                        <select required="" class="form-control" id="newearningcode"
                                                            name="newearningcode">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" readonly="readonly" required="required"
                                                            class="form-control" id="earningamount" name="earningamount"
                                                            placeholder="Amount">
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal fade" id="newemployeededuction" tabindex="-1" role="dialog"
                    aria-labelledby="newemployeededuction" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                <h5 class=" modal-title" id="newemployeeearning">Add New Deduction for this Employee
                                </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newedeductioncode" id="form_newedeductioncode"
                                    method="post" action="classes/controller.php?act=addemployeededuction">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select required="required" class="form-control"
                                                            id="newdeductioncode" name="newdeductioncode">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" required="required" class="form-control"
                                                            id="deductionamount" name="deductionamount"
                                                            placeholder="Amount">
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal fade" id="newemployeededuction_union" tabindex="-1" role="dialog"
                    aria-labelledby="newemployeededuction_union" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                <h5 class=" modal-title" id="newemployeeearning">Add Union Deduction for this Employee
                                </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newedeductioncodeunion"
                                    id="form_newedeductioncodeunion" method="post"
                                    action="classes/controller.php?act=addemployeedeductionunion">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select required="required" class="form-control"
                                                            id="newdeductioncodeunion" name="newdeductioncodeunion">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" required="required" class="form-control"
                                                            id="deductionamountunion" name="deductionamountunion"
                                                            placeholder="Amount">
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal fade" id="newtempemployeededuction" tabindex="-1" role="dialog"
                    aria-labelledby="newtempemployeededuction" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                <h5 class=" modal-title" id="newemployeeearning">Add New Deduction for this Employee
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_temp" id="form_temp" method="post"
                                    action="classes/controller.php?act=newtempemployeededuction">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select required="required" class="form-control"
                                                            id="newdeductioncodetemp" name="newdeductioncodetemp">
                                             ...
                                             ?>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">No of Time to Run(In
                                                        Month)</label>
                                                    <div class="col-md-7">
                                                        <input type="number" min="0" required="required"
                                                            class="form-control" id="no_times" name="no_times"
                ...
                <div class="modal fade" id="gradeStep" tabindex="-1" role="dialog" aria-labelledby="gradeStep"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newgrade_stepemployee"
                                    id="form_newgrade_stepemployee" method="post" action="classes/runUpdateGrade1.php">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" id="grade" name="grade"
                                                            value="<?php echo $empGrade; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" id="step" name="step"
                                                            value="<?php echo $empStep; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Grade:</label>
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" id="new_grade"
                                                            name="new_grade" value="" required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Step:</label>
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" id="new_step"
                                                            name="new_step" value="" required>
                                                    </div>
                                                </div>
                ...
                <div class="modal fade" id="prorate" tabindex="-1" role="dialog" aria-labelledby="prorate"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newprotateemployee"
                                    id="form_newprotateemployee" method="post" action="classes/getProrate.php">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                    ...
                                    ?>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">No. of Day in Current
                                                        Period:</label>
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" id="no_days"
                                                            name="no_days" value="<?php echo $dayss; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">No of Days to
                                                        Calculate</label>
                                                    <div class="col-md-7">
                                                        <input type="number" min="0" max="<?php echo $dayss; ?>"
                                                            value="0" required="required" class="form-control"
                                                            id="daysToCal" name="daysToCal" placeholder="No of Days">
                                                    </div>
                                                </div>
                ...
                <div class="modal fade" id="loan_corporate" tabindex="-1" role="dialog" aria-labelledby="loan_corporate"
                    aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header modal-title" style="background: #6e7dc7;">
                                <h5 class=" modal-title" id="newemployeeearning">Add New Loan/Corporate for this
                                    Employee</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal" name="form_newloanemployeededuction"
                                    id="form_newloanemployeededuction" method="post"
                                    action="classes/controller.php?act=loan_corporate">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-body">
                                                <input type="hidden" name="curremployee"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select required="required" class="form-control"
                                                            id="newdeductioncodeloan" name="newdeductioncodeloan">
                                                            <option>- - Select Deduction/Allowance - -</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" min="0" value="0" required="required"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" min="0" value="1" required="required"
                                                            class="form-control" id="no_times_repayment"
                                                            name="no_times_repayment" placeholder="Run Times">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-4 control-label">Monthly Repayment</label>
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control" id="monthlyRepayment"
                                                            name="monthlyRepayment" placeholder="Monthly Repayment">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="number" class="form-control" id="Balance"
                                                            name="Balance" placeholder="Balance" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        $("#no_times_repayment").blur(function() {
            ...
            var monthlyPayment = ((parseFloat($("#Principal").val()) + parseFloat($("#interest")
            .val())) / parseFloat($("#no_times_repayment").val()));
        ...
        $("#updateGradeStepButton").click(function() {
            if ($("#new_grade").val() == '0' || ($("#new_step").val() == '0') || ($("#new_step")
                .val() == '') || ($("#new_grade").val() == '')) {
        ...
        $("#newemployeeearning,#newemployeededuction,#newemployeededuction_union,#newtempemployeededuction,#loan_corporate")
