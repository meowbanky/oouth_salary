    ...
    <div class="container">
        ...
        <div class="content">
            <div class="alert alert-warning">
                <strong>⚠️ Security Notice:</strong> API secrets are highly sensitive. Never share them or commit them
                to version control.
            </div>
            ...
            <div id="resultSection" style="display: none;">
                ...
                <div class="signature-generator">
                    ...
                    <div class="test-section">
                        ...
                        <button class="btn" onclick="generateSignature()" style="margin-bottom: 15px;">Generate
                            Signature</button>
                        ...
                        <div id="signatureResult" style="display: none;">
                            ...
                            <div class="alert alert-success" style="margin-top: 15px;">
                                ...
                                <pre id="curlCommand"
                                    style="white-space: pre-wrap; margin-top: 10px; font-family: monospace; font-size: 12px;"></pre>
                            </div>
                        </div>
                    </div>
                </div>
