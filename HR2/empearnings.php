	                                                                    ...
	                                                                    <?php
	                                                                        try{
	                                                                            ...
	                                                                            foreach ($res as $row => $link) {
	                                                                                ...
	                                                                                $myperiod = $payp->execute(array($_SESSION['companyid'], $link['earningDeductionCode']));
	                                                                                $final = $payp->fetch();
	                                                                                //End ED Fetch
	                                                            ...
	                                                            <div class="payslip-body">
	                                                                ...
	                                                                <div class="row payslip-data">
	                                                                    ...
	                                                                    try{
	                                                                        ...
	                                                                        $fin = $query->execute(array($thisemployee, $_SESSION['companyid'], 'Deduction', '483', $_SESSION['currentactiveperiod'], '1'));
	                                                                        $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                                    ...
                                                    <table class="table table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                                try{
                                                                    $query = $conn->prepare('SELECT * FROM employee_earnings_deductions WHERE employeeId = ? AND companyId = ? AND transactionType = ? AND payPeriod = ? AND active = ? ORDER BY earningDeductionCode');
                                                                    $fin = $query->execute(array($currentemp, $_SESSION['companyid'], 'Earning', $_SESSION['currentactiveperiod'], '1'));
                                                                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                                                    //print_r($res);
                                                            ...
                                                            <?php
                                                                try{
                                                                    ...
                                                                    $fin = $query->execute(array($currentemp, $_SESSION['companyid'], '482', $_SESSION['currentactiveperiod'], '1'));
                                                                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                                                    //print_r($res);
                                                            ...
                                                            <?php
                                                                try{
                                                                    ...
                                                                    $fin = $query->execute(array($currentemp, $_SESSION['companyid'], 'Deduction', '482', '483', $_SESSION['currentactiveperiod'], '1'));
                                                                    $res = $query->fetchAll(PDO::FETCH_ASSOC);
                                                                        ...
                                                                        ?><tr class="odd gradeX"> 
                                                                            <?php 
                                                                                ...
                                                                                echo '</td><td class="align-right">' . number_format($link['amount']) . '</td>';
                                                                                    ...
                                                                                    $result = $edquery->execute(array($link['earningDeductionCode'], $_SESSION['companyid'], '0'));
