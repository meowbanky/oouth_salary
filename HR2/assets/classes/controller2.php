<?php
	...
	$source = 'controller2.php' ; //$_SERVER['HTTP_REFERER'];
	//$hostname = gethostbyname($_SERVER['REMOTE_ADDR');
	//session variables
	$comp = '1';

$_POST['upassword'] = '12345';
$_POST['uname']  = 'info@democompany.com';
	...
	switch ($act) {
		case 'login':
			...
			$query = $conn->prepare('SELECT * FROM users WHERE emailAddress = ?');
			$fin = $query->execute(array($_POST['uname']));
