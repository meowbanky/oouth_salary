	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix sales_content_minibar">
			...
			<div id="breadcrumb" class="hidden-print">
				...
				<a class="current" href="bank.php">Bank</a>
			</div>
			<div class="clear"></div>
						...
						<div class="portlet-body">
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="classes/controller.php?act=bank">
													<div class="row">
														<div class="col-md-12">
															<div class="form-body">
																<div class="form-group">
																	...
																	<div class="col-md-7">
																		<input type="text" required class="form-control" name="bankname" placeholder="Bank Name">
																	</div>
																</div>
															</div>
														</div>
							...
							<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
								...
								<tbody>
									...
									?><tr class="odd gradeX">
												<td><input type="checkbox"></td> <?php echo '<td>' . $link['BCODE'] .  '</td><td>' . $link['BNAME'] . '</td>
