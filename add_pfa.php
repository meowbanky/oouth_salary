	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix sales_content_minibar">
			...
			<div id="breadcrumb" class="hidden-print">
				...
				<a class="current" href="add_pfa.php">Pension Fund Admin</a>
			</div>
			<div class="clear"></div>
						...
						<div class="portlet-body">
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header" style="background: #6e7dc7;">
												...
												<h4 class="modal-title">Add New PFA</h4>
											</div>
											<div class="modal-body">
												<form class="form-horizontal" method="post" action="classes/controller.php?act=pfa">
													<div class="row">
														<div class="col-md-12">
															<div class="form-body">
																<div class="form-group">
																	<label class="col-md-4 control-label">PFA</label>
																	<div class="col-md-7">
																		<input type="text" required class="form-control" name="pfaname" placeholder="PFA Name">
																	</div>
																</div>
															</div>
														</div>
							...
							<table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
								...
								<tbody>
									...
									?><tr class="odd gradeX">
												<td><input type="checkbox"></td> <?php echo '<td>' . $link['PFACODE'] .  '</td><td>' . $link['PFANAME'] . '</td>
