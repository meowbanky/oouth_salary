                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                ...
                                <!-- <div id="edit_newearning" class="modal fade" tabindex="-1" data-width="560">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header" style="background: #6e7dc7;">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    ?><div id="edit_newearning<?php echo  $link['ed_id']; ?>" class="modal fade" tabindex="-1" data-width="560">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header" style="background: #6e7dc7;">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="form-horizontal" method="post" action="classes/controller.php?act=editearning">
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-body">
                                                                            <div class="form-group">
                                                                                <label class="col-md-4 control-label">Description</label>
                                                                                <div class="col-md-7">
                                                                                    <input type="text" value="<?php echo $link['edDesc']; ?>" required class="form-control" name="eddescription" autocomplete="off" placeholder="Title of New Earning">
                                                                                    <input type="hidden" name="ed_id" value="<?php echo  $link['ed_id']; ?>">
                                                                                </div>
                                                                            </div>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" data-dismiss="modal" class="btn btn-outline dark">Cancel</button>
                                                            <button type="submit" class="btn red">Edit</button>
                                                        </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <tr class="odd gradeX">
                                                <td></td><?php echo '<td>' . $link['ed_id'] . '</td><td>' . $link['edDesc'] . '</td><td>';
                                                            if ($link['edType'] == 1) {
                                                                $edtype = 'Earning';
                                                            ...
                                                            echo '<span class="label label-inverse label-sm label-' . styleLabelColor($edtype) . '">' . $edtype . '</span>
                                                               
                                                                </td>';

                                                            echo '<td> <a class="btn blue btn-sm" data-toggle="modal" data-target="#edit_newearning' . $link['ed_id'] . '"> Edit <i class="fa fa-edit"></i></a>
                                          </td>';
