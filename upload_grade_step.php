...
<head>
    ...
    <title>Update Bulk Grade/Step - Salary Management System</title>
        ...
        <div class="flex-1 p-6">
            <div class="container mx-auto">
                <nav class="mb-6">
                    ...
                    <span>Update Bulk Grade/Step</span>
                </nav>
                ...
                <h1 class="text-3xl font-bold text-gray-800 mb-6 flex items-center">
                    <i class="fas fa-upload mr-2"></i> Update Bulk Grade/Step
                </h1>

                <div class="bg-white p-6 rounded-lg shadow-md">
                    <form id="upload_excel" action="excel_import/import_grade_step.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-center">
                                <a href="download/grade_step.xlsx" class="text-blue-600 hover:underline">
                                    <i class="fas fa-download mr-2"></i> Download Grade/Step Template
                                </a>
                            </div>
                        </div>
