	...
	<div id="wrapper">
		...
		<div id="content" class="clearfix sales_content_minibar">
			...
			<div id="breadcrumb" class="hidden-print">
				<a href="home.php"><i class="fa fa-home"></i> Dashboard</a><a class="current" href="pfa.php">Pension Fund Admin.</a>
			</div>
			<div class="clear"></div>
										...
										<nav aria-label="page navigation example" class="hidden-print">
											<ul class="pagination">
												...
												for ($i = 1; $i <= $total_pages; $i++) {
													...
													echo '"><a class="page-link" href="pfa.php?page=' . $i . '">' . $i . '</a></li>';
												}
												?>
											</ul>
										</nav>
						...
						select: function(event, ui) {
							...
							$('#add_item_form').ajaxSubmit({
								...
								success: function(data) {
									window.location.href = "pfa.php?item=" + $item;
								}
